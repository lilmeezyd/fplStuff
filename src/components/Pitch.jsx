    ...
    <div>
      ...
      <div className="chip-buttons p-2">
        ...
        className={`${+wc1 === +eventId+curPage ? 'bt-active' : ''} btn-dark`} onClick={activateWC1}>
          <div>Wildcard 1</div>
          <div>{+chips.wildcard.event < +eventId + curPage &&
        ...
        <Button onClick={activateWC2} className="btn-dark">
          Wildcard 2
        </Button>
        <Button onClick={activateBB} className="btn-dark">
          Bench Boost
        </Button>
        <Button onClick={activateFH} className="btn-dark">
          FreeHit
        </Button>
